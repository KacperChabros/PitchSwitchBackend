...
namespace PitchSwitchBackend.Migrations
{
    ...
    [Migration("20241031160711_Add_Journalist_Status_Applications")]
    partial class Add_Journalist_Status_Applications
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PitchSwitchBackend.Models.Comment", b =>
                {
            ...
            modelBuilder.Entity("PitchSwitchBackend.Models.JournalistStatusApplication", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("JournalistStatusApplications");
                });
            ...
            modelBuilder.Entity("PitchSwitchBackend.Models.Post", b =>
                {
                    b.Property<int>("PostId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PitchSwitchBackend.Models.Comment", b =>
                {
                    ...
                    b.HasOne("PitchSwitchBackend.Models.Post", "Post")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("PitchSwitchBackend.Models.JournalistStatusApplication", b =>
                {
                    b.HasOne("PitchSwitchBackend.Models.AppUser", "SubmittedByUser")
            ...
            modelBuilder.Entity("PitchSwitchBackend.Models.Post", b =>
                {
                    ...
                    b.HasOne("PitchSwitchBackend.Models.Transfer", "Transfer")
                        .WithMany("Posts")
                        .HasForeignKey("TransferId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("PitchSwitchBackend.Models.TransferRumour", "TransferRumour")
                        .WithMany("Posts")
                        .HasForeignKey("TransferRumourId")
                        .OnDelete(DeleteBehavior.Restrict);
